...
**Purpose:** Review completed work against requirements, modern Angular best practices, and the repository style guide before it cascades into more work.
...
Subagent (general-purpose):
  ...
  prompt: |
    ...
    **Head:** [HEAD_SHA]
    ...
    Review against this repository's style guides. Always read
    `style-guide/style-guide.md` first, then read the specific guide for every
    touched file type:
    ...
    - Accessibility: `style-guide/style-guide.a11y.md`
